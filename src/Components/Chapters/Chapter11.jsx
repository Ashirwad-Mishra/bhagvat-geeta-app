...
const chapterData = allChaptersData.find(ch => ch.chapter === 11);

const Chapter11 = ({ targetVerseId }) => {
  ...
  if (!chapterData) {
    return <div>Chapter 11 data not found. Please update gita-data.js</div>;
  }
