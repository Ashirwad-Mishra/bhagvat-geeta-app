...
const chapterData = allChaptersData.find(ch => ch.chapter === 10);

const Chapter10 = ({ targetVerseId }) => {
  ...
  if (!chapterData) {
    return <div>Chapter 10 data not found. Please update gita-data.js</div>;
  }
