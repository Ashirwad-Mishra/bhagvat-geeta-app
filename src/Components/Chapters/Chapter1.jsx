...
import './Chapter1.css'; // The CSS file we just updated
...
const Chapter1 = ({ targetVerseId }) => {
  // NEW: State to track the current verse index
  const [currentVerseIndex, setCurrentVerseIndex] = useState(0);
  const [translationsVisible, setTranslationsVisible] = useState(true);

  // This effect now sets the page index when a search result is clicked
  useEffect(() => {
    if (targetVerseId) {
