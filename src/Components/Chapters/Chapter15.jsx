...
const chapterData = allChaptersData.find(ch => ch.chapter === 15);

const Chapter15 = ({ targetVerseId }) => {
  ...
  if (!chapterData) {
    return <div>Chapter 15 data not found. Please update gita-data.js</div>;
  }
