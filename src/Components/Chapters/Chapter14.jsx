...
const chapterData = allChaptersData.find(ch => ch.chapter === 14);

const Chapter14 = ({ targetVerseId }) => {
  ...
  if (!chapterData) {
    return <div>Chapter 14 data not found. Please update gita-data.js</div>;
  }
