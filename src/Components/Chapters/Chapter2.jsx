...
import './Chapter1.css'; // We can reuse the same CSS file

// Import the data from the central file
import { allChaptersData } from '../../gita-data.js';
const chapterData = allChaptersData.find(ch => ch.chapter === 2);

const Chapter2 = ({ targetVerseId }) => {
  ...
  if (!chapterData) {
    return <div>Chapter 2 data not found. Please update gita-data.js</div>;
  }
